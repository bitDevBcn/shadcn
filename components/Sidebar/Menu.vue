...
const items = ref([
  ...
  },
  {
    title: "Account",
    path: "/account",
    icon:"material-symbols-light:manage-accounts-rounded"
  },
  {
    title: "Contacts",
    path: "/contacts",
    ...
    <div>
      ...
      <div class="px-4 grow">
        <div class="grid gap-2">
          <div v-for="(item, index) in items" :key="index" class="flex item-center gap-2 px-2 py-1 rounded cursor-pointer hover:bg-neutral-100">
